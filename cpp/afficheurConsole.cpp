...
void afficheurConsole::afficherFormation(const formation & f)
{
	*d_ost<<f.nom()<<" avec "<<f.nombreEtudiant()<<" etudiants.";
}
 ...
 */
void afficheurConsole::afficherSemaine(const horaire & h)
{
    *d_ost<<std::setw(2)<<h.semaine();
}
...
void afficheurConsole::afficherLesCours(const listeCours & lC)
{
	*d_ost<<"Liste des cours :"<<std::endl;
	...
	{
		*d_ost<<"______________________________________________________"<<endl;
		*d_ost<<"Semaine | Jour     | Horaire       | Professeur      |"<<endl;
		*d_ost<<"------------------------------------------------------"<<endl;
 ...
 */
void afficheurConsole::afficherProfesseur(const professeur & p)
{
    *d_ost<<p.nom();
}
 ...
 */
void afficheurConsole::afficherSalle(const salle & s)
{
    *d_ost<<s.nom()<<" avec "<<s.nombrePlaces()<<" places.";
}
